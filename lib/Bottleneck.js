  ...
  class Bottleneck {
    ...
    _free(index, job, options, eventInfo) {
      ...
      return _asyncToGenerator(function* () {
        var e, running;
        try {
          var _yield$_this$_store$_ = yield _this._store.__free__(index, options.weight);
          running = _yield$_this$_store$_.running;
    ...
    _addToQueue(job) {
      ...
      return _asyncToGenerator(function* () {
        ...
        options = job.options;
        try {
          var _yield$_this2$_store$ = yield _this2._store.__submit__(_this2.queued(), options.weight);
          reachedHWM = _yield$_this2$_store$.reachedHWM;
          blocked = _yield$_this2$_store$.blocked;
          strategy = _yield$_this2$_store$.strategy;
        } catch (error1) {
          error = error1;
    ...
    submit(...args) {
      ...
      if (typeof args[0] === "function") {
        ...
        ref = args, (_ref = ref, _ref2 = _toArray(_ref), fn = _ref2[0], args = _ref2.slice(1), _ref), (_splice$call = splice.call(args, -1), _splice$call2 = _slicedToArray(_splice$call, 1), cb = _splice$call2[0], _splice$call);
        options = parser.load({}, this.jobDefaults);
      } else {
        var _ref3, _ref4, _splice$call3, _splice$call4;
        ref1 = args, (_ref3 = ref1, _ref4 = _toArray(_ref3), options = _ref4[0], fn = _ref4[1], args = _ref4.slice(2), _ref3), (_splice$call3 = splice.call(args, -1), _splice$call4 = _slicedToArray(_splice$call3, 1), cb = _splice$call4[0], _splice$call3);
